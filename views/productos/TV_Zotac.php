...
<!-------------------------------Articulo----------------------------------->
    <div class="headingx">
        <h1> Tarjeta De Video Zotac NVIDIA GeForce GTX 1650 SUPER Twin Fan, 4GB 128-Bit GDDR6, PCI Express 3.0 </h1>
    </div> 
    <hr>
    <div class="container">
        <div class="row">
            ...
            <div id="derecha">
                ...
                <div class="caracteristicas">
                    ...
                    <ul class="carac">
                        <li>Frecuencia boost: <b>1725 MHz</b></li>
                        <li>Núcleos CUDA: <b>1280</b></li>
                        <li>Cantidad de puertos HDMI: <b>1</b></li>
                        <li>Cantidad de DisplayPorts: <b>1</b></li>
                    </ul>
                    <hr>
                    <br>
                    <form method="post" action="../../controllers/comprarController.php">
                       <div>
                           ...
                           <input name="product-name" class="form-input"  type="text" readonly value="Tarjeta de Video Zotac NVIDIA GeForce GTX 1650 SUPER Twin Fan" />
                       </div>
                       <div>
                       ...
                       <div>
                           ...
                           <input name="product-price" class="form-input" type="number" readonly value="4699" />
                        </div>
