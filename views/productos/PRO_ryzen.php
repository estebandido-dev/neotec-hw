...
<!-------------------------------Articulo----------------------------------->
    <div class="headingx">
        <h1> Procesador AMD Ryzen 5 3600, S-AM4, 3.60GHz, 32MB L3 Cache, con Disipador Wraith Stealth  </h1>
    </div> 
    <hr>
    <div class="container">
        <div class="row">
            ...
            <div id="derecha">
                <div class="contenido-producto">
                    ...
                    <div class="oferta"> <span>$5040.00</span> $4818.00</div>
                    <hr>
                </div> 
                <div class="caracteristicas">
                    <h3>Caracteristicas</h3>
                    <ul class="carac">
                        <li>Familia de procesador: <b>AMD Ryzen 5</b></li>
                        <li>Model del procesador: <b>3600</b></li>
                        <li>Frecuencia del procesador: <b>3.6 GHz</b></li>
                        <li>Socket del procesador <b>Socket AM4</b></li>
                        <li>Número de núcleos: <b>6</b></li>
                    </ul>
                    <hr>
                    <br>
                    <form method="post" action="../../controllers/comprarController.php">
                       <div>
                           ...
                           <input name="product-name" class="form-input"  type="text" readonly value="Procesador AMD Ryzen 5 3600" />
                       </div>
                       <div>
                       ...
                       <div>
                           ...
                           <input name="product-price" class="form-input" type="number" readonly value="4818" />
                        </div>
