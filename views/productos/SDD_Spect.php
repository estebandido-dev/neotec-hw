...
<!-------------------------------Articulo----------------------------------->
    <div class="headingx">
        <h1>SSD XPG Spectrix S40G, 512GB, PCI Express 3.0, M.2</h1>
    </div> 
    <hr>
    <div class="container">
        <div class="row">
            ...
            <div id="derecha">
                <div class="contenido-producto">
                    ...
                    <div class="oferta"> <span>$1640.00</span> $1530.00</div>
                    <hr>
                </div> 
                <div class="caracteristicas">
                    <h3>Caracteristicas</h3>
                    <ul class="carac">
                        <li>Capacidad: <b>512 GB</b></li>
                        <li>Interface: <b>PCI Express 3.0</b></li>
                        <li>Velocidad de lectura: <b>3500 MB/s</b></li>
                        <li>Velocidad de escritura: <b>3000 MB/s</b></li>
                    </ul>
                    <hr>
                    <br>
                    <form method="post" action="../../controllers/comprarController.php">
                       <div>
                           ...
                           <input name="product-name" class="form-input"  type="text" readonly value="SSD XPG Spectrix S40G, 512GB" />
                       </div>
                       <div>
                       ...
                       <div>
                           ...
                           <input name="product-price" class="form-input" type="number" readonly value="1530" />
                        </div>
