...
<!-------------------------------Articulo----------------------------------->
    <div class="headingx">
        <h1> Tarjeta Madre ASUS micro ATX MB PRIME A320M-K, S-AM4, AMD A320, HDMI, 32GB DDR4 para AMD  </h1>
    </div> 
    <hr>
    <div class="container">
        <div class="row">
            ...
            <div id="derecha">
                <div class="contenido-producto">
                    ...
                    <div class="oferta"> <span>$1719.00</span> $1610.00</div>
                    <hr>
                </div> 
                <div class="caracteristicas">
                    <h3>Caracteristicas</h3>
                    <ul class="carac">
                        <li>Familia de procesador: <b>AMD</b></li>
                        <li>Circuito integrado de tarjeta madre: <b>AMD A320</b></li>
                        <li>Socket de procesador: <b>Socket AM4</b></li>
                        <li>Circuito integrado <b>AMD A320</b></li>
                        <li>Memoria interna, máxima <b>32 GB</b></li>
                        <li>Tipo de memoria: <b>DDR4-SDRAM</b></li>
                    </ul>
                    <hr>
                    <br>
                    <form method="post" action="../../controllers/comprarController.php">
                       <div>
                           ...
                           <input name="product-name" class="form-input"  type="text" readonly value="Tarjeta Madre ASUS micro ATX MB PRIME A320M-K" />
                       </div>
                       <div>
                       ...
                       <div>
                           ...
                           <input name="product-price" class="form-input" type="number" readonly value="1610" />
                        </div>
